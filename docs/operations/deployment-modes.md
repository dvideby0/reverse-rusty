...
| **Online / cross-process resize** | `/_cluster/resize` is in-process blue/green only; the remote topology changes shard count by redeploy | [ADR-078](../decisions/adr-078-cluster-resize.md); [ADR-167](../decisions/adr-167-cluster-resize-api-contract.md); [roadmap](../roadmap.md#automatic-and-remote-cluster-resize) |
