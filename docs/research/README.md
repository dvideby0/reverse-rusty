...
- [`mokaccino.md`](mokaccino.md) — source-level study of the `mokaccino` Rust percolator (closest peer): architecture diff, what to borrow, build-vs-buy, head-to-head benchmark plan.
