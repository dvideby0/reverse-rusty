...
pub(crate) use admin::{
    ...
    cluster_checkpoint, cluster_compact, cluster_deregister_node, cluster_flush, cluster_handoff,
    cluster_health, cluster_metrics, cluster_reassign, cluster_rebalance, cluster_reconcile,
    cluster_register_node, cluster_resize, cluster_resync, cluster_root, cluster_state,
    cluster_stats,
};
